from src.basic_cnn_cifar10.data_preparation import data_preparation
from tensorflow.keras.callbacks import ModelCheckpoint, EarlyStopping
from src.basic_cnn_cifar10.model_architectures import model_architecture
...
def start_training(model, X_train, y_train):
    ...
    check_pointer = ModelCheckpoint(filepath='artifacts/model/basic_cnn_cifar10/model.weights.best.hdf5',
                                    verbose=1,
                                    save_best_only=True)
